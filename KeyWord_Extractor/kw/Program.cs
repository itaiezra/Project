...
namespace kw
{
	class Program
	{
		static void Main(string[] args)
		{
            ...
            string gettys = File.ReadAllText(@"E:\My Files\Documents\School\PROJECT\DB\Q\1.txt");
            string gu = File.ReadAllText(@"E:\My Files\Documents\School\PROJECT\DB\Q\1.txt");
